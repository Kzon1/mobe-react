import {
  ...
  export default function Update({navigation, route}){
    ...
    const [statusParking, setStatusParking] = useState(myHike.parkingStatus);
    const [name, setName] = useState(myHike.name);
    const [location, setLocation] = useState(myHike.location);
    const [date, setDate] = useState(myHike.date);
    const [show, setShow] = useState(false);
    const [selectedDate, setSelectedDate] = useState();
    const [length, setLength] = useState(myHike.length);
    const [difficultyLevel, setDifficultyLevel] = useState(myHike.difficulty);
    const [description, setDescription] = useState(myHike.description);
